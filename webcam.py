...
gesture_dict = {
    ...
    'Play pause': 2, 2: 'Play pause',
    'Volume Down': 3, 3: 'Volume Down',
    'Backward': 4, 4: 'Backward',
    'Forward': 5, 5: 'Forward',
    'Volume Up': 6, 6: 'Volume Up',
...
parser.add_argument("-cp", "--checkpoint", default="./trainings/jpeg_model/jester_conv3d_9_classes/model_best.pth.tar", help="Location of model checkpoint file")
